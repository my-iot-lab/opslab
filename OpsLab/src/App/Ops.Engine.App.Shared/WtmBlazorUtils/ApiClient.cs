...
public class ApiClient
{
    ...
    public async Task<ApiResult<T>> CallAPI<T>(string url, HttpMethodEnum method, HttpContent content, int? timeout = null, string proxy = null)
        where T : class
    {
        ...
        try
        {
            ...
            {
                HttpMethodEnum.GET => await Client.GetAsync(url),
                HttpMethodEnum.POST => await Client.PostAsync(url, content),
                HttpMethodEnum.PUT => await Client.PutAsync(url, content),
    ...
    public async Task<ApiResult<T>> CallAPI<T>(string url, HttpMethodEnum method, IDictionary<string, string> postdata, int? timeout = null, string proxy = null) where T : class
    {
        ...
        {
            List<KeyValuePair<string, string>> paras = new();
    ...
    public async Task<ApiResult<T>> CallAPI<T>(string url, HttpMethodEnum method, IDictionary<string, string> postdata, byte[] filedata,
        string filename, int? timeout = null, string proxy = null)
        where T : class
    {
    ...
    public async Task<List<SelectedItem>> CallItemsApi(string url, HttpMethodEnum method = HttpMethodEnum.GET, object postdata = null,
        int? timeout = null, string proxy = null, string placeholder = null, List<string> values = null)
    {
        var result = await CallAPI<List<ComboSelectListItem>>(url, method, postdata, timeout, proxy);
        List<SelectedItem> rv = new();
        if (values == null)
        {
