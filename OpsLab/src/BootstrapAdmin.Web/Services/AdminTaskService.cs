...
class AdminTaskService : BackgroundService
{
    ...
    public AdminTaskService(IDict dict) => _dictService = dict;
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken) => Task.Run(() =>
    {
        ...
        //TaskServicesManager.GetOrAdd("健康检查", token => Task.FromResult(_dictService.SaveHealthCheck()), TriggerBuilder.Build(Cron.Minutely(10)));
    }, stoppingToken);
}
