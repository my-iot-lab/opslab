...
public enum ConnErrorCode : int
{
    ...
    OmronAddressMustBeZeroToFifteen = 20201,
    ...
    MelsecPleaseReferToManualDocument = 20301,
...
public static class ErrorCodeExtensions
{
    ...
    /// <returns></returns>
    public static string Desc(this ConnErrorCode source)
    {
        var fieldName = source.ToString();
        MemberExpression memberExpression = Expression.Field(null, typeof(ConnErrorCode), fieldName);
