...
public class MelsecMcRNet : NetworkDeviceBase
{
	...
	public static OperateResult<MelsecMcRDataType, int> AnalysisAddress(string address)
	{
            try
		{
			...
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.LSTS, Convert.ToInt32(address[4..], MelsecMcRDataType.LSTS.FromBase));
			}
			if (address.StartsWith("LSTC"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.LSTC, Convert.ToInt32(address[4..], MelsecMcRDataType.LSTC.FromBase));
			}
			if (address.StartsWith("LSTN"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.LSTN, Convert.ToInt32(address[4..], MelsecMcRDataType.LSTN.FromBase));
			}
			if (address.StartsWith("STS"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.STS, Convert.ToInt32(address[3..], MelsecMcRDataType.STS.FromBase));
			}
			if (address.StartsWith("STC"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.STC, Convert.ToInt32(address[3..], MelsecMcRDataType.STC.FromBase));
			}
			if (address.StartsWith("STN"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.STN, Convert.ToInt32(address[3..], MelsecMcRDataType.STN.FromBase));
			}
			if (address.StartsWith("LTS"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.LTS, Convert.ToInt32(address[3..], MelsecMcRDataType.LTS.FromBase));
			}
			if (address.StartsWith("LTC"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.LTC, Convert.ToInt32(address[3..], MelsecMcRDataType.LTC.FromBase));
			}
			if (address.StartsWith("LTN"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.LTN, Convert.ToInt32(address[3..], MelsecMcRDataType.LTN.FromBase));
			}
			if (address.StartsWith("LCS"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.LCS, Convert.ToInt32(address[3..], MelsecMcRDataType.LCS.FromBase));
			}
			if (address.StartsWith("LCC"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.LCC, Convert.ToInt32(address[3..], MelsecMcRDataType.LCC.FromBase));
			}
			if (address.StartsWith("LCN"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.LCN, Convert.ToInt32(address[3..], MelsecMcRDataType.LCN.FromBase));
			}
			if (address.StartsWith("TS"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.TS, Convert.ToInt32(address[2..], MelsecMcRDataType.TS.FromBase));
			}
			if (address.StartsWith("TC"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.TC, Convert.ToInt32(address[2..], MelsecMcRDataType.TC.FromBase));
			}
			if (address.StartsWith("TN"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.TN, Convert.ToInt32(address[2..], MelsecMcRDataType.TN.FromBase));
			}
			if (address.StartsWith("CS"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.CS, Convert.ToInt32(address[2..], MelsecMcRDataType.CS.FromBase));
			}
			if (address.StartsWith("CC"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.CC, Convert.ToInt32(address[2..], MelsecMcRDataType.CC.FromBase));
			}
			if (address.StartsWith("CN"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.CN, Convert.ToInt32(address[2..], MelsecMcRDataType.CN.FromBase));
			}
			if (address.StartsWith("SM"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.SM, Convert.ToInt32(address[2..], MelsecMcRDataType.SM.FromBase));
			}
			if (address.StartsWith("SB"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.SB, Convert.ToInt32(address[2..], MelsecMcRDataType.SB.FromBase));
			}
			if (address.StartsWith("DX"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.DX, Convert.ToInt32(address[2..], MelsecMcRDataType.DX.FromBase));
			}
			if (address.StartsWith("DY"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.DY, Convert.ToInt32(address[2..], MelsecMcRDataType.DY.FromBase));
			}
			if (address.StartsWith("SD"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.SD, Convert.ToInt32(address[2..], MelsecMcRDataType.SD.FromBase));
			}
			if (address.StartsWith("SW"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.SW, Convert.ToInt32(address[2..], MelsecMcRDataType.SW.FromBase));
			}
			if (address.StartsWith("X"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.X, Convert.ToInt32(address[1..], MelsecMcRDataType.X.FromBase));
			}
			if (address.StartsWith("Y"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.Y, Convert.ToInt32(address[1..], MelsecMcRDataType.Y.FromBase));
			}
			if (address.StartsWith("M"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.M, Convert.ToInt32(address[1..], MelsecMcRDataType.M.FromBase));
			}
			if (address.StartsWith("L"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.L, Convert.ToInt32(address[1..], MelsecMcRDataType.L.FromBase));
			}
			if (address.StartsWith("F"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.F, Convert.ToInt32(address[1..], MelsecMcRDataType.F.FromBase));
			}
			if (address.StartsWith("V"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.V, Convert.ToInt32(address[1..], MelsecMcRDataType.V.FromBase));
			}
			if (address.StartsWith("S"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.S, Convert.ToInt32(address[1..], MelsecMcRDataType.S.FromBase));
			}
			if (address.StartsWith("B"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.B, Convert.ToInt32(address[1..], MelsecMcRDataType.B.FromBase));
			}
			if (address.StartsWith("D"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.D, Convert.ToInt32(address[1..], MelsecMcRDataType.D.FromBase));
			}
			if (address.StartsWith("W"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.W, Convert.ToInt32(address[1..], MelsecMcRDataType.W.FromBase));
			}
			if (address.StartsWith("R"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.R, Convert.ToInt32(address[1..], MelsecMcRDataType.R.FromBase));
			}
			if (address.StartsWith("Z"))
			{
				return OperateResult.CreateSuccessResult(MelsecMcRDataType.Z, Convert.ToInt32(address[1..], MelsecMcRDataType.Z.FromBase));
			}
			return new OperateResult<MelsecMcRDataType, int>(ErrorCode.NotSupportedDataType.Desc());
		}
		catch (Exception ex)
		{
