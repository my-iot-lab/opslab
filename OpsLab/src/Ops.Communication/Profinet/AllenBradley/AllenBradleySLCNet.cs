...
public sealed class AllenBradleySLCNet : NetworkDeviceBase
{
	...
	public override OperateResult<bool> ReadBool(string address)
	{
		...
		return OperateResult.Ok(operateResult.Content.ToBoolArray()[bitIndex]);
	}
	...
	public override async Task<OperateResult<byte[]>> ReadAsync(string address, ushort length)
	{
		...
		return OperateResult.Ok(extra.Content);
	}
	...
	public override async Task<OperateResult<bool>> ReadBoolAsync(string address)
	{
		...
		return OperateResult.Ok(read.Content.ToBoolArray()[bitIndex]);
	}
