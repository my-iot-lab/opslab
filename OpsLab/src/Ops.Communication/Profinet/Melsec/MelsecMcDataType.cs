...
/// </summary>
public sealed class MelsecMcDataType
{
	/// <summary>
	/// X输入继电器
	/// </summary>
	public static readonly MelsecMcDataType X = new(156, 1, "X*", 16);

	/// <summary>
	/// Y输出继电器
	/// </summary>
	public static readonly MelsecMcDataType Y = new(157, 1, "Y*", 16);
	...
	/// 累计定时器的当前值
	/// </summary>
	public static readonly MelsecMcDataType SN = new(200, 0, "SN", 100);
	...
	/// 文件寄存器
	/// </summary>
	public static readonly MelsecMcDataType Keyence_ZR = new(176, 0, "ZR", 10);
