...
/// </summary>
public sealed class CallbackTaskQueueManager : IDisposable
{
    private const int Capacity = 64;
    private readonly Channel<PayloadContext> _queue;

    public CallbackTaskQueueManager()
    {
    ...
    public async ValueTask QueueAsync(PayloadContext item, CancellationToken cancellationToken = default)
    {
